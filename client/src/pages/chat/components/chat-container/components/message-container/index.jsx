...
const MessageContainer = () => {
          ...
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#8417ff]/5 text-[#15154e]/90 border-[#15154e]/50"
          ...
          <div
            className={`${
              message.sender._id === userInfo.id
                ? "bg-[#e7e7ec] text-[#15154e]/90 border-[#15154e]/50"
                : "bg-[#e7e7ec] text-white/80 border-[#ffffff]/20"
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[60vw] lg:w-[65vw] xl:w-[75vw] w-full bg-[#e7e7ec] ">
      {renderMessages()}
